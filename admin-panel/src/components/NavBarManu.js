...
import { faCoffee, faUser, faList, faHome, faTrash, faPlus, faSearch, faUserCircle } from '@fortawesome/free-solid-svg-icons'
        ...
        return (
            <div>
                <Navbar bg="light" expand="lg">
                    <Navbar.Brand href="#home" className='navbar-brand'> <FontAwesomeIcon icon={faUserCircle} fontSize="24px"  />{''} Admin Panel</Navbar.Brand>
